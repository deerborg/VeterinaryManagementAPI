...
public class CustomerServiceImp implements CustomerService {
    ...
    @Override
    public ResultData<CustomerResponse> addCustomer(CustomerSaveRequest customer) { // Section 10 - Pet owner registration
    ...
    @Override
    public ResultData<List<CustomerResponse>> getByCustomerName(String name) { // Section 11 - filter by name
    ...
    @Override
    public ResultData<List<AnimalResponse>> getByAnimalList(long id) { // Section - 14 Listing owned animals
